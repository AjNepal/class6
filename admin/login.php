...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="thirdparty/adminlte/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>STUTSMAN</b> Admin Panel</a>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="thirdparty/adminlte/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
